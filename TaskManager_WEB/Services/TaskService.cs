...
namespace TaskManager_WEB.Services
{
    public class TaskService : BaseService, ITaskService
    {
        ...
        public TaskService(IHttpClientFactory httpClientFactory, IConfiguration configuration, IHttpContextAccessor httpContextAccessor) : base(httpClientFactory, httpContextAccessor)
        {
        ...
        public Task<T> DeleteTask<T>(Guid id)
        {
            return Send<T>(new APIRequest()
            {
        ...
        public Task<T> GetTaskById<T>(Guid id)
        {
            return Send<T>(new APIRequest()
            {
        ...
        public Task<T> UpdateTask<T>(Guid id, TaskUpdateDto task)
        {
            return Send<T>(new APIRequest()
            {
